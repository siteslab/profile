 ...
 <div id="main-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?> clearfix">
      <div class="<?php print nucleus_group_class("content, sidebar_first");?>">
	    <div class="<?php print nucleus_group_class("content");?> left-group">
		<?php if($menu_bar = render($page['menu_bar'])): ?>
			<!-- MAIN NAV -->
			<div id="menu-bar-wrapper" class="wrapper <?php print nucleus_group_class("content");?>">			  
				<div class="grid-inner clearfix">
				  <?php print $menu_bar; ?>
				</div>			  
			</div>
		...
		<?php if($slideshow = render($page['slideshow'])): ?>
			<!-- SLIDESHOW -->
			<div id="slideshow-wrapper" class="wrapper <?php print nucleus_group_class("content");?>">			  
			  <div class="grid-inner clearfix">
			    <?php print $slideshow; ?>
			  </div>			 
			</div>
		  ...
		  <!-- MASS TOP -->  <?php if($messages || $page['help']): ?>
		<!-- HELP & MESSAGES -->
		<div id="system-messages-wrapper" class="wrapper <?php print nucleus_group_class("content");?>">		 
		  <div class="grid-inner clearfix">
	  ...
	  <?php endif; ?>
            <?php if ($mass_top = render($page['mass_top'])): ?>  
              <div id="mass-top-wrapper" class="mass-top <?php print nucleus_group_class("content");?>">  
                <div class="grid-inner clearfix">  
                  <?php print($mass_top);?>  
                </div>  
              </div>  
